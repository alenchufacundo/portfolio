    ...
    <main class="container">
        ...
        <div class="row">
            <div class="col-sm-6 col-12">
                <p>Te invito a que te contactes enviándome un mensaje o bien por
                    <a href="https://api.whatsapp.com/send?phone">whatsapp</a>.
                </p>
            </div>
            <div class="col-sm-6 col-12 ">
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        <textarea name="txtMensaje" cols=30 rows=05 id="txtMensaje"
